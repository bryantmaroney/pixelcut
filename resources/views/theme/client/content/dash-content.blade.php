    ...
    <table class="table table-striped">
        ...
        @foreach($Contents as $k => $v)
            <tr class="customTrStyle">
                ...
                <td>
{{--                    <a  href="{{route('edit',$v->id)}}" class="dash-page-listactions" style="margin-top: 4px">Edit </a>--}}
                    <a  href="{{route('content-review',$v->id)}}" class="dash-page-listactions" style="margin-top: 4px">Review & Approve </a>
                    <a  href="#" class="dash-page-listactions ml-1" style="margin-top: 4px">Approve</a>
                    <a  href="#" class="dash-page-listactions ml-1" style="margin-top: 4px">Discard</a>
                </td>
            </tr>
        @endforeach
        </tbody>
