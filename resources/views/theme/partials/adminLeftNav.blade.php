<div class="dash-left">
    ...
    <ul class="dash-sidebarlist">
        ...
        <li  onclick="window.location.href='{{route('list-projects')}}'" @if(\Request::route()->getName() == 'list-projects') class="active" @elseif(\Request::route()->getName() == 'add-new-project') class="active" @elseif(\Request::route()->getName() == 'editProject') class="active" @endif>
