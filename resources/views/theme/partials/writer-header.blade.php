<div class="dash-header">
    ...
    <div class="dash-header-title">
        ...
        <input type="button" value="EDIT PROFILE" class="dash-page-listactions" onclick="window.location.href='{{route('writerEditProfile')}}'" style="float:right;margin-right:9px;height:40px;font-weight:800;">
    </div>
</div>
