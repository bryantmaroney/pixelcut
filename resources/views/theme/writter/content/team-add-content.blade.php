		...
		<div class="dash-contentarea-wrapper">
			...
			<form method="post" action="{{route('contentSave')}}"><!-- start form -->
				...
				<div class="team-addcontent-titlebox">
					<div>
						<label>TITLE*</label>
						<input class="addcontent-titlefield" name="title">
					</div>
					<div>
						<label>PROJECT*</label>
				...
				<div class="team-addcontent-keywordsbox">
					<div class="team-addcontent-leftkeywords">
						...
						<div>
							...
							<input type="number" name="target_keyword">
						</div>
					</div>
					<div class="team-addcontent-rightkeywords">
						<div>
							<label>FRAMING KEYWORDS</label>
							<textarea name="framing_keyword" class="textarea"></textarea>
						</div>
					</div>
				</div>
				...
				<div class="team-addcontent-publish">
					<div>
						...
						<input id="publishdate" name="publish_date" type="datetime-local" placeholder="Select a date">
						<span></span>
					</div>
					<div>
						<label>TARGET WRITTEN-BY DATE</label>
						<input id="targetdate"  name="target_date" type="datetime-local" placeholder="Select a date">
						<span></span>
					</div>
				</div>
				...
				<div class="team-addcontent-publishpage">
					<div>
						...
						<input type="text" name="publish_page" placeholder="/example-location/">
					</div>
					<div>
						<label>WRITER</label>
						<select name="writter">
				...
				<div class="team-addcontent-notes">
					<div>
						<label>NOTES</label>
						<textarea type="text" name="notes" placeholder="General notes, internal linking, words to avoice, etc."></textarea>
					</div>
				</div>
				...
				<div class="team-addcontent-meta">
					<div>
						...
						<textarea type="text" name="meta_discription" placeholder="Meta description" onkeyup="countChar(this)"></textarea>
					</div>
				</div>
